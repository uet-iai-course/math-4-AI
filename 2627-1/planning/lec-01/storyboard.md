...
| Hồi quy logistic | M03, G00 | G00, G01, G03 | G00, G03 | G01–G03, T01 | K03 | G04 | Dữ liệu nhãn nhị phân và hàm mũ → lập mô hình biên tuyến tính, rồi phân biệt cận dưới đúng với nghiệm | $z_1,z_2,y$ → $a_i,y_i,w,L$ → $x,C,f_0$ | LLO1, CLO1 |
...
| G01 | Bài toán phân loại bằng biên tuyến tính | Khái quát ví dụ cam thành đại lượng đo độ đúng của dự đoán; minh họa mặt phẳng đặc trưng, hai miền dấu, biên qua gốc và véc tơ pháp tuyến $w$ | G00 → G02 | LLO1, CLO1 | Tách từ U04; thêm SVG `g01-linear-boundary-2d.svg` |
...
| U04 | G00–G04 | Thêm ví dụ phân loại cam để tạo cầu nối; tách hồi quy logistic và thêm phản ví dụ không tồn tại nghiệm |
...
- L04 → G00: chuyển từ dự đoán một giá trị liên tục sang quyết định phân loại chất lượng trên dây chuyền.
- G00 → G01: khái quát hai đặc trưng của quả cam thành vector đặc trưng và biên tuyến tính.
