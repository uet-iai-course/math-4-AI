...
| C — Newton không ràng buộc | Dùng độ cong để tạo bước và tiêu chuẩn dừng | Gradient, Hessian và backtracking | Newton đầy đủ, decrement và hai pha | Nâng khuôn A từ bậc nhất lên bậc hai |
| D — Hàm tự điều chỉnh | Nêu lớp hàm cho phân tích Newton bất biến affine | Newton decrement và đạo hàm cấp ba | Bảo đảm có điều kiện theo decrement cùng giới hạn | Giải thích khi cấu trúc hàm thay thế hằng số khó biết |
| E — Newton với đẳng thức | Giữ hoặc phục hồi $Ax=b$ | KKT Bài 03 và Newton C; D không giữ khả thi | Hai hệ Newton–KKT, decrement đẳng thức và phần dư | Mở rộng quy trình sang mô hình có đẳng thức |
...
| C02 | Định nghĩa Newton bằng hệ tuyến tính, không nghịch đảo | Ví dụ → C04 đo độ giảm | LLO6/LLO8 | sửa cách trình bày triển khai |
...
- Đưa ví dụ và trực quan trước định nghĩa ở B03, C03 và D03 để hoàn tất hành trình sáu bước.
...
- Không sao chụp hình MIT; năm SVG được tự vẽ từ công thức trong `math-spec.md`.
- Dùng $\delta_N$ thay ký hiệu $\lambda$ cho Newton decrement để không xung đột nhân tử Lagrange Bài 03.
