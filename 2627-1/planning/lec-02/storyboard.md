...
| A06 | Biến tính tựa lồi thành thuật toán khả thi có quy tắc dừng; nhãn cột nêu rõ phép thử $S_t\ne\varnothing$ | Tập mức lồi $S_t$ → bài tập phân biệt lồi và tựa lồi | Đầu vào, đầu ra, cận và dung sai | sửa: hoàn chỉnh giao diện và nghĩa của “khả thi” |
