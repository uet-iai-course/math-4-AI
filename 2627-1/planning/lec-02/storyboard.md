...
| A05 | Định nghĩa tựa lồi bằng tập mức dưới và dùng $x^3$ trên $[-1,1]$ để phân biệt trực tiếp tựa lồi với lồi | Các phép cải dạng chuẩn → phép thử mức cho thuật toán chia đôi | Kiểm tra tựa lồi và phản ví dụ cho chiều đảo | sửa: dùng ví dụ tựa lồi nhưng không lồi ngay khi định nghĩa |
| A06 | Áp dụng phép thử mức cho phân thức $f(x)=(x^2+1)/(x+2)$; nêu lại $D$, $f$, $\phi_t$, bất biến khoảng, tốc độ co và quy tắc dừng | Tập mức lồi $S_t$ → bài tập phân biệt lồi và tựa lồi | Đầu vào, đầu ra, cận, bảo đảm sau $k$ vòng và dung sai | sửa: bảng tự chứa đủ bài toán và nghĩa của “khả thi” |
...
| C04 | Giải thích phép đổi log và phát biểu tương đương GP–log với đúng điều kiện về nghiệm đạt được và giá trị tối ưu dương, hữu hạn | Dạng GP chưa lồi theo biến gốc → ứng dụng dầm dùng đúng log-tổng-mũ | Cải dạng lồi có chứng nhận | sửa: tách tương đương tập giá trị khỏi kết luận về nghiệm tối ưu |
