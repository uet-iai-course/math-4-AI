...
|---|---|---|---|---|---|---|---|---|---|
| A1. Dạng chuẩn và cải dạng | A01 | A03 | A03 | A02, A04 | Không áp dụng: A04 chỉ minh họa ngắn ba phép cải dạng; khả năng chuyển giao được đo tại A07 | A07 (ca 1, 3) | Tập lồi, hàm lồi → nhận dạng và cải dạng tương đương; LLO3, minh chứng bộ phận CLO1 | $D,\mathcal F,p^*,f_i,h_j$ | 0,22 tiết LT + 0,05 tiết BT |
...
| B1. LP | B01 | B03 | B03 | B02 | B03 | B09 (ca a, c) | Đa diện, hàm affine → nhận dạng LP và đọc nghiệm; LLO3 | $c,A,b,G,h$ | 0,17 tiết LT + 0,08 tiết BT |
| B2. QP | B02 | B05, B06 | B05, B06 | B04 | B05 | B09 (ca e) | Dạng toàn phương, PSD → kiểm tra QP và hồi quy ràng buộc; LLO3, minh chứng bộ phận CLO1 | $P,q,r,A^\dagger$ | 0,20 tiết LT + 0,12 tiết BT |
...
| D1. SDP theo nón | D01 | D02, D05 | D05 | D03, D04 | D06 | D10 (chặn trị riêng) | Ma trận đối xứng → đọc thứ tự PSD và LMI; LLO3 | $E,K,G,h,\preceq_K,\mathbb S_+^r,F(x)$ | 0,28 tiết LT + 0,10 tiết BT |
| D2. Tối ưu Pareto | D06 | D08 | D08 | D07 | D09 | D10 (quan hệ trội) | Thứ tự theo nón → đánh giá sai số–chi phí và chọn điểm tối tiểu; LLO3, minh chứng bộ phận CLO1 | $F,\mathcal O,\preceq_K,\lambda$ | 0,17 tiết LT + 0,10 tiết BT |
...
Trình tự trong từng khái niệm giữ đúng nhu cầu → trực quan/ví dụ → hình thức → ứng dụng → bài tập. Một số vai trò được gộp: A03 vừa trực quan vừa ví dụ dẫn nhập cho cải dạng; A05 vừa tạo nhu cầu vừa cho ví dụ tựa lồi; A06 vừa hình thức vừa ứng dụng của kiểm tra mức; B10 vừa ứng dụng vừa bài tập QCQP; C05, D05 và D08 vừa trực quan vừa ví dụ. Không có bước bị bỏ ngầm.
...
| P01 | Ngăn bài dạy lại Lecture 01 và nêu sản phẩm quan sát được | Tên và chủ đề bài → chuẩn đầu ra chính thức cần đo | Tiên quyết, LLO3 | thêm |
...
| A03 | Chứng minh biểu diễn ban đầu có thể che cấu trúc lồi | Nhu cầu cải dạng → khuôn ký hiệu để mô tả miền, tập khả thi và giá trị | Cải dạng có kiểm chứng | sửa: đưa ví dụ trước khuôn tổng quát |
| A02 | Xác lập miền, tập khả thi và $p^*$ sau khi ví dụ đã tạo nhu cầu ký hiệu | Ví dụ tương đương → dạng chuẩn lồi và các phép cải dạng có chứng nhận | Phân biệt $\pm\infty$ | sửa: chuyển thành ngoại lệ nền sau ví dụ |
| A04 | Nêu dạng chuẩn và minh họa ngắn ba phép cải dạng với đủ điều kiện tương đương | Khuôn tối ưu tổng quát → định nghĩa tựa lồi qua tập mức | Hình thức và minh họa; chưa nhận vai ứng dụng | sửa: bổ sung $\operatorname{range}(F)=\ker A$, $\exists s$ và giữ ràng buộc epigraph |
| A05 | Định nghĩa tựa lồi tổng quát và minh họa cả mức âm | Các phép cải dạng chuẩn → thuật toán chia đôi có đầu vào/đầu ra | Kiểm tra tựa lồi | sửa: thêm $S_t$ cho mọi $t\in\mathbb R$ |
| A06 | Biến tính tựa lồi thành thuật toán khả thi có quy tắc dừng | Tập mức lồi $S_t$ → bài tập phân biệt lồi và tựa lồi | Đầu vào, đầu ra, cận và dung sai | sửa: hoàn chỉnh giao diện thuật toán |
...
| B03 | Cụ thể hóa hình học LP bằng ví dụ số | Phân cấp ba lớp → dạng LP tổng quát rút ra từ đường mức và đa diện | Nghiệm $(3,0)$ | sửa: đặt trước dạng chuẩn LP |
...
| B05 | Nối độ cong bậc hai với bình phương tối thiểu và sửa điều kiện của công thức giả nghịch đảo | Giới hạn mục tiêu affine → QP hai biến cho thấy độ cong theo tọa độ | Ứng dụng LS | sửa: ví dụ dẫn nhập QP |
...
| B08 | Cung cấp phản ví dụ khi ma trận không PSD | Chứng nhận PSD của QP → dạng QCQP lồi với PSD cho mọi hàm bậc hai | Chứng minh tập không lồi | sửa: phản ví dụ chuẩn bị giả thiết QCQP |
...
| C05 | Cho ví dụ dẫn nhập có nghiệm chính xác dùng AM–GM | Nhu cầu mô hình tích → thuật ngữ đơn thức và đa thức dương | Nghiệm $(2,2)$ | sửa: đặt trước thuật ngữ hình thức |
...
| C04 | Giải thích và chứng minh phép đổi log | Dạng GP chưa lồi theo biến gốc → ứng dụng dầm dùng đúng log-tổng-mũ | Cải dạng lồi | sửa: nối trực tiếp tới ứng dụng |
...
| D04 | Nêu đúng kiểu ma trận và tên LMI của SDP | Khuôn nón → ứng dụng LMI khối biểu diễn chuẩn phổ | Dạng chuẩn SDP | sửa: thu hồi thuật ngữ được báo trước ở D05 |
...
| D08 | Cho một đánh đổi mục tiêu có thể kiểm tra bằng đơn điệu | Thứ tự theo nón chuyển từ ma trận sang vector → định nghĩa phần tử nhỏ nhất và tối tiểu | Trực quan quan hệ trội | sửa: bỏ thuật ngữ Pareto trước định nghĩa |
| D07 | Phân biệt phần tử nhỏ nhất và tối tiểu từ ví dụ đánh đổi | Đường đánh đổi không có điểm trội tất cả → vô hướng hóa để chọn một điểm tối tiểu | Khái niệm Pareto | sửa: hình thức sau trực quan |
| D09 | Tách trọng số dương khỏi hai đầu mút và nối đánh đổi AI | Khái niệm điểm tối tiểu → bài tập song song về LMI và quan hệ trội | Đánh giá sai số–chi phí, CLO1 | sửa: phân biệt $0<\lambda<1$ với $\lambda\in\{0,1\}$ |
| D10 | Đo đồng thời LMI và quan hệ trội | Hai nhánh SDP/Pareto → bản đồ quyết định thu hồi toàn bộ lớp bài toán | Bài tập LLO3 | thêm |
...
| Z02 | Kiểm tra giả thiết và chuyển giao sang hồi quy AI có ràng buộc với đủ kiểu $X,y,w,\tau$ | Pipeline tổng hợp → tài liệu nguồn và cầu nối sang đối ngẫu | LLO3; minh chứng bộ phận CLO1 | sửa: thêm ca AI tích hợp và dữ kiện kích thước |
| Z03 | Truy nguyên nguồn và tạo cầu nối tới đối ngẫu | Tự kiểm tra LLO3 → Lecture 03 dùng dạng chuẩn làm đầu vào cho đối ngẫu | Đọc thêm, phụ thuộc | thêm |
