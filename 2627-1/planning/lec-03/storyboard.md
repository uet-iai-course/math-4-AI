# Storyboard Bài 03 — Bản nội dung 47 trang
...
| Đối ngẫu mạnh và Slater (0,45 tiết) | S03-01 → S03-01 (khoảng 4,5 đến 5, tiếp nối hình S02-07) → S03-02 → S03-03 (phát biểu theo yêu cầu người dùng) → S03-02b (trực quan giả thiết) → S03-03a–03c → S03-04–05 → S03-06 | Gộp nhu cầu và trực quan khoảng cận trên cùng trang; ví dụ L(x,2) cho cận khít trước định lý. Đầu vào L,g,p*,d*; đầu ra LLO4: biết kiểm tra cùng một điểm nghiêm và kết luận đúng. Truyền x*=2 nhưng phân biệt x̄=3; S03-03 nêu bất đẳng thức nghiêm; S03-02b minh họa bằng khoảng dư f1(3)=-1 và lân cận quanh 3. Gộp trực quan và ví dụ trên S03-02b; ứng dụng và bài tập giữ S03-04 và S03-06. Phân bổ lại trong 0,45 tiết hiện có, không tăng thời lượng bài. Câu nối: Slater cho điều kiện đủ, trường hợp biên kiểm tra giới hạn của chiều suy luận. |
...
| KKT (1,00 tiết) | S05-01 → S05-01 → S05-01–02 → S05-03 → S05-04–06, S05-05b–c, S05-05a, S05-06a–b → S05-07 | Gộp nhu cầu, gradient cân bằng 4 và −4 ở ví dụ đã biết; ví dụ hoạt động λ=0 trước hệ tổng quát. Đầu vào cận khít, gradient của hàm lồi; đầu ra LLO4/CLO1: giải nhánh và chứng nhận hồi quy. Truyền x,λ; đổi sang w có kích thước được nêu. Chứng minh tính đủ, rồi tính cần, sau đó dùng phản ví dụ để kiểm tra giới hạn giả thiết; hồi quy được giải tổng quát rồi tính đủ hai trọng số trước bài tự luyện. Ví dụ hai chiều có X=I2,y=(3,4),τ=1 truyền nguyên dữ liệu vào bốn nhóm KKT. Câu nối: tính lồi biến dừng thành cực tiểu; hệ KKT vì vậy đủ. |
...
| S03-03 | Điều kiện Slater | Cung cấp một giả thiết kiểm tra được thay cho việc phải giải hai bài toán mới biết cận khít. | S03-02 → S03-02b | LLO4/CLO1 | sửa — triển khai khung đã duyệt |
| S03-02b | Ý nghĩa và trực quan của Slater | Sau cận khít, giải thích khoảng dư quanh điểm 3 bằng đoạn [2,5; 3,5]; phân biệt điều kiện trên miền với yêu cầu về nghiệm tối ưu. | S03-03 → S03-03a | LLO4/CLO1 | thêm — trực quan hóa giả thiết sau phát biểu định lý theo yêu cầu mới của người dùng |
| S03-03a | Chứng minh định lý Slater | Giải thích vì sao khả thi nghiêm bảo đảm cận khít và đạt đối ngẫu. | S03-02b → S03-03b | LLO4/CLO1 | thêm — chứng minh theo yêu cầu; ba bước chính trên trang, định nghĩa hai tập và phép tách trong ghi chú |
...
| S05-05b | Chứng minh điều kiện đủ của KKT | Chứng minh điểm dùng tính lồi để bảo đảm toàn cục và nối KKT trở lại đối ngẫu yếu. | S05-05 → S05-05c | LLO4/CLO1 | thêm/tách — giảm tải lập luận |
| S05-05c | Chứng minh điều kiện cần của KKT | Dùng nhân tử đạt đối ngẫu và chuỗi cận khít để suy ra riêng bù trừ và dừng. | S05-05b → S05-05a | LLO4/CLO1 | thêm — bổ sung chứng minh chiều cần theo yêu cầu; chỉ rõ hai kết luận của Slater được dùng |
| S05-05a | Nghiệm tối ưu không thỏa KKT | Dùng miền chỉ có một điểm để thấy nghiệm tối ưu có thể không có nhân tử KKT khi thiếu giả thiết chính quy. | S05-05c → S05-06 | LLO4/CLO1 | thêm — ví dụ và lời giải theo yêu cầu người dùng |
| S05-06 | KKT trong hồi quy có ràng buộc | Áp dụng các kết quả vừa học cho mô hình AI có kích thước thực tế; giải thích vai trò giới hạn trọng số. | S05-05a → S05-06a | LLO4/CLO1 | sửa — triển khai khung đã duyệt |
...
S05-05c dùng chu trình rút gọn của phần chứng minh: nhu cầu giải thích chiều cần đã phát biểu → Slater và chuỗi cận khít → kiểm tra từng nhóm KKT → phản ví dụ giới hạn. Không thêm ví dụ số riêng vì S05-04 đã giải trọn ví dụ và S05-05a kiểm tra giả thiết. Giữ tổng thời lượng mạch KKT; phân bổ lại phần diễn giải cho hai chứng minh liên tiếp.
