...
| Đa diện và dạng chuẩn | B01 | B02 | B02, B05 | B03–B06 | B05–B06 | B07 | Mô hình LP → đa diện, dạng chuẩn, BFS; truyền cùng $x_1,x_2$, thêm $s_1,s_2,s_3$ và cơ sở $\{x_1,x_2,s_2\}$; LLO18/CLO1 | B02 gộp trực quan với ví dụ; B07 kiểm BFS ngay tại $(30,12)$. “Miền có vô số điểm nhưng được tạo bởi hữu hạn nửa không gian.” Tổng $0{,}35$ LT + $0{,}15$ BT. |
| Điểm cực và thuật toán ở mức ý niệm | C01 | C02, C09 | C04 và ví dụ hộp hạt ở B02 | C03, C05–C06, C08 | C07–C09 | C10 | Đa diện/dạng chuẩn → phân loại trạng thái và vận dụng bảo đảm điểm cực; truyền $P,A,b,c$ rồi đổi sang dữ kiện C10; LLO18/CLO1 | C06 dùng nón tiếp xúc và tính hữu hạn của tối ưu để nối mọi điểm cực chưa tối ưu với một điểm cực kề cải thiện; suy biến chỉ ảnh hưởng biểu diễn cơ sở và pivot. C08–C09 dùng chuỗi số $0\to60\to96$; C10 chuyển giao sang đa diện mới. Tổng $0{,}50$ LT + $0{,}30$ BT. |
| Hồi quy $L_1$ | A05 | A07 | A07 | A07 | A07 | A07 | LP cơ bản → mô hình hồi quy $L_1$; truyền $a_i\in\mathbb R^n$, $b_i\in\mathbb R$, phần dư $a_i^Tx-b_i$ và $t_i\in\mathbb R_+$; củng cố LLO17/CLO1 | Dùng chu trình rút gọn nhu cầu → hình thức → kiểm tra vì đây là kỹ thuật phụ: A07 gộp mô hình, ứng dụng và ví dụ số $|x-1|+|x-3|$ để tự kiểm tính tương đương; không dùng C11 làm bài tập cho cụm này. Tổng $0{,}15$ LT + $0{,}05$ BT. |
...
| B06 | Nêu đủ điều kiện cơ sở, nghiệm cơ sở và tính khả thi. | Biến phụ → bài tập. | BFS LLO18. | sửa: thêm $A_B^{-1}b\ge0$. |
...
| C06 | Nêu định lý tối ưu và bổ đề tổng quát: điểm cực chưa tối ưu có điểm cực kề cải thiện khi đa diện có điểm cực và tối ưu hữu hạn. | Tồn tại → bốn trạng thái và Bài 08. | Bảo đảm tối ưu LLO18. | sửa: dùng nón tiếp xúc và hướng cạnh; suy biến ảnh hưởng pivot/quay vòng, không ảnh hưởng sự tồn tại của đỉnh kề cải thiện. |
| C07 | Phân loại đầy đủ vô nghiệm, không bị chặn, tối ưu duy nhất, nhiều tối ưu. | Định lý → thuật toán. | Chẩn đoán trạng thái LLO18. | thêm: SVG bốn trạng thái. |
| C08 | Mô tả thuật toán ở mức ý niệm và gắn chuỗi hộp hạt $0\to60\to96$. | Trạng thái → đường đi trực quan. | Mô tả ở mức ý niệm cho LLO18. | sửa: tên thuần Việt, thêm số cụ thể, không tableau/pivot. |
...
| C11 | Buộc nối mô hình, dạng chuẩn, đỉnh, trạng thái và mô tả thuật toán ở mức ý niệm trước khi mở DP. | C10 → biên D01. | Bài tập tích hợp LLO17–18. | chuyển bài tích hợp về cuối mạch C để hoàn tất đánh giá LP trước biên DP. |
