...
| A03 | Làm cụ thể ba loại bộ nhớ trên cùng $g_1$ trước khi đặt công thức thuật toán. | Trực quan → AdaGrad. | Ví dụ LLO14: $r_1=(4,1)$, $v_1^{\mathrm{RMS}}=(0{,}4,0{,}1)$, $m_1^{\mathrm{Adam}}=(0{,}2,0{,}1)$, $v_1^{\mathrm{Adam}}=(0{,}004,0{,}001)$. | sửa: ba thẻ fragment hiện tổng không quên, trung bình có quên và hai mômen; hộp fragment cuối nối sang công thức; $g_2$ truyền sang A08. |
